        ...
        <div class="bg-white">
            <div class="max-w-screen-3xl px-4 lg:px-14 mx-auto pt-16">
                <div class="justify-between items-center flex w-full">
                    ...
                    <a href="{{ route('artworks.index') }}" class="flex items-center justify-center px-6 py-2 border-2 border-neutral-800 text-neutral-800 hover:text-white hover:bg-red-500 hover:border-transparent transition-all duration-150">
