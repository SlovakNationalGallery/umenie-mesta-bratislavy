...
@section('content')
    <search.filters-controller v-cloak v-slot="{ filters, query, onCheckboxChange, artworks, isFetching, ...controller }">
        <div class="px-4 lg:px-14 mx-auto fixed w-full z-10 bg-neutral-100 top-36 lg:top-28 pt-4">
            {{-- Mobile filter --}}
            ...
            {{-- Desktop filter --}}
            <div class="bg-neutral-100 fixed z-10 inset-x-0">
                            ...
                            <search.filter-search :options="options" v-slot="{ searchResults }">
                                <div v-for="option, index in searchResults" :key="option.value" class="flex">
                                    ...
                                    <label :for="'filters.categories.' + index" class="whitespace-nowrap pr-4">
                                        @{{ option.label }} <span
                                            class="font-semibold">(@{{ option.count }})</span>
                                    </label>
                                </div>
                            </search.filter-search>
                        </search.popover-filter>
        ...
        <div class="bg-white min-h-screen pt-16 mt-2 lg:pt-10">
            <div class="lg:px-14 px-4 max-w-screen-3xl mx-auto mt-4 lg:flex pb-10">
                ...
                <div class="lg:flex-grow mt-8 lg:mt-0">
                    ...
                    <div class="flex -mx-2 lg:-mx-4 gap-3 mt-10 lg:mt-16 flex-wrap">
